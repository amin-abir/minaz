...
License: http://fontello.com/ fontello is licensed under the MIT License 
License Url: https://github.com/fontello/fontello/blob/master/LICENSE

Fontello compiled font
Entypo by Daniel Bruce — CC BY-SA 4.0.
License: http://www.entypo.com/faq.php It’s released under the license CC BY-SA 4.0
...
lazy-load-images.js
License: lazy-load-images.js is licensed under the MIT License
Source: https://github.com/codefacebook/lazy-load-images.js
...
- minaz_site_logo()
- minaz_site_description()
- minaz_skip_link_focus_fix()
- minaz_skip_link()
